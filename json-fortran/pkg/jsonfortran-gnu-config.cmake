...
# Provide the targets
set_and_check ( jsonfortran-gnu_CONFIG_INSTALL_DIR "${PACKAGE_PREFIX_DIR}/jsonfortran-gnu-6.9.0/cmake" )
include ( "${jsonfortran-gnu_CONFIG_INSTALL_DIR}/jsonfortran-gnu-targets.cmake" )

# Make the module files available via include
set_and_check ( jsonfortran_INCLUDE_DIRS "${PACKAGE_PREFIX_DIR}/jsonfortran-gnu-6.9.0/lib" )
